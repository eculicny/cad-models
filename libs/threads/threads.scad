    ...
    difference() {
        union() {
            if (!groove) {
                if (!test) {
                    metric_thread_turns(
                        diameter, pitch, length, internal, n_starts,
            ...
            difference() {
                ...
                if (groove) {
                    cylinder(
                        r1=diameter / 2, r2=tapered_diameter / 2,
                        h=length, $fn=n_segments
                    );
                } else if (internal) {
                    cylinder(
                        r1=diameter / 2 - h * h_fac1, r2=tapered_diameter / 2 - h * h_fac1,
                        h=length, $fn=n_segments
                    );
                } else {
                    ...
                    // External thread.
                    cylinder(
                        r1=diameter / 2 - h * h_fac2, r2=tapered_diameter / 2 - h * h_fac2,
                        h=length, $fn=n_segments
                    );
                }
            ...
            if (internal) {
                ...
                if (leadin == 2 || leadin == 3) {
                    ...
                    cylinder(
                        r1=diameter / 2 - h + h * h_fac1 * leadfac,
                        r2=diameter / 2 - h,
        ...
        if (!internal) {
            ...
            if (leadin == 2 || leadin == 3) {
                difference() {
                    ...
                    cylinder(
                        r2=diameter / 2, r1=diameter / 2 - h * h_fac1 * leadfac, h=h * h_fac1 * leadfac,
                        $fn=n_segments
                    );
                }
            }
            ...
            if (leadin == 1 || leadin == 2) {
                translate([0, 0, length + 0.05 - h * h_fac1 * leadfac]) {
                    difference() {
                        ...
                        cylinder(
                            r1=tapered_diameter / 2, r2=tapered_diameter / 2 - h * h_fac1 * leadfac, h=h * h_fac1 * leadfac,
                            $fn=n_segments
                        );
                    }
                }
...
module english_thread(
    ...
    metric_thread(
        mm_diameter, mm_pitch, mm_length, internal, n_starts,
        ...
        union() {
            for (i = [-1 * n_starts:n_turns + 1]) {
                translate([0, 0, i * pitch]) {
                    metric_thread_turn(
                        diameter, pitch, internal, n_starts,
    ...
    for (i = [0:n_segments - 1]) {
        ...
        rotate([0, 0, (i + 0.5) * 360 * fraction_circle + 90]) {
            translate([0, 0, i * n_starts * pitch * fraction_circle]) {
                ...
                thread_polyhedron(
                    (diameter - taper * (z + i * n_starts * pitch * fraction_circle)) / 2,
