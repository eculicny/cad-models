...
difference() {
    ...
    translate(v=[base_box_wall, base_box_wall, base_box_wall])
        union() {
            ...
            // depression cutout
            translate(v=[base_box_full_x - base_box_depression_x, -1.2, -(base_box_long_z - base_box_short_z)])
                // note that the y-direction is a hair larger to attempt to accomodate the F-map tile
