module frame_box_negative(viewing_window_size_arr, backing_board_size_arr, frame_thickness, interior_wall_thickness) {
    ...
    union() {
        // inset cut
        translate([interior_wall_thickness, interior_wall_thickness, frame_thickness - backing_board_thickness])
